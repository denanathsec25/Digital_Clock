...
REM
REM Generated by Vivado on Sat Jul 11 14:28:48 +0530 2026
...
echo "xvlog --incr --relax -prj Digital_clk_tb_vlog.prj"
call xvlog  --incr --relax -prj Digital_clk_tb_vlog.prj -log xvlog.log
